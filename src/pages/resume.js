          ...
          <Stack>
            ...
            >
              <Resume.UnorderedList>
                <Resume.ListItem>
                  Wrote an SVG charting library from scratch; used it to build
          ...
          <Grid>
            ...
            <Resume.Item title="Leadership">
              <Resume.UnorderedList>
                ...
                <Resume.ListItem>
                  Establishing and documenting coding standards and team
                  processes
                </Resume.ListItem>
            ...
            <Resume.Item title="Technologies">
              <Resume.UnorderedList>
                ...
                <Resume.ListItem>
                  <strong>Frameworks:</strong> React, Redux, Vue, Express,
                  MongoDB
                </Resume.ListItem>
                <Resume.ListItem>
                  <strong>Tools:</strong> Webpack, Babel, Jest, Prettier,
                  ESLint, Stylelint
                </Resume.ListItem>
              </Resume.UnorderedList>
            </Resume.Item>
            ...
            <Resume.Item title="Collaboration">
              <Resume.UnorderedList>
                ...
                <Resume.ListItem>
                  Communicating with project managers and product owners to
